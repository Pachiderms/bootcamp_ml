...
class MyLogisticRegression():
    ...
    def fit_(self, x, y):
        ...
        for _ in range(self.max_iter):
            ...
            grad = log_gradient(x, y, new_theta) if self.penality == None else vec_reg_logistic_grad(y, x, self.thetas, self.lambda_)
    ...
    def loss_(self, y, y_hat):
        return vec_log_loss_(y, y_hat) if self.penality == None else reg_log_loss_(y, y_hat, self.thetas, self.lambda_)
